...
//             : 'bg-white text-black-900 border border-gray-700 rounded-bl-sm shadow-sm'
//         }`}>
//           {message.replyTo && (
...
//             }`}>
//               <p className={`text-xs ${isOwn ? 'text-blue-200' : 'text-black-600'} mb-1`}>
//                 Replying to {message.replyTo.sender?.name}
//               </p>
//               <p className={`text-sm ${isOwn ? 'text-blue-100' : 'text-black-700'} truncate`}>
...
//                 {message.media && (
//                   <div className="bg-black-600 rounded-lg p-2">
//                     <p className="text-xs text-black-600">📎 {message.messageType}</p>
//                     <p className="text-xs text-black-500">{message.media.filename}</p>
//                   </div>
//                 )}
//                 {message.content && (
//                   <p className="text-sm">{message.content}</p>
...
//             <span className={`text-xs ${isOwn ? 'text-blue-200' : 'text-black-500'}`}>
...
//                 <span
//                   key={index}
//                   className="bg-white border border-gray-800 rounded-full px-2 py-1 text-xs shadow-sm"
//                 >
//                   {reaction.emoji}
//                 </span>
//               ))}
  ...
  return (
    <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-4`}>
      ...
      >
        ...
        {/* Time + status */}
        <div
          className={`flex items-center justify-end space-x-1 mt-1 text-[11px] ${
